...
const scaleIn = {
  ...
  visible: { opacity: 1, scale: 1, y: 0, transition: { duration: 0.8, ease, delay: 0.2 } },
};
...
export function Hero() {
  return (
    <section className="relative overflow-hidden pb-section-hero pt-[140px] lg:pt-[160px]">
      ...
      <div className="absolute top-[10%] right-[15%] h-[300px] w-[300px] rounded-full bg-brand-200/20 blur-[100px]" />
      <div className="absolute bottom-[5%] left-[10%] h-[200px] w-[200px] rounded-full bg-accent-lavender/30 blur-[80px]" />

      <Container>
        <div className="relative grid items-center gap-xxl lg:grid-cols-[1fr_1.1fr]">
          {/* Left column — Copy */}
          <motion.div
          ...
          >
            ...
            <motion.h1
              variants={fadeUp}
              className="text-h1 mt-lg text-text-primary leading-[1.1]"
            >
              Workplace learning{" "}
              <span className="relative inline-block">
                <span className="gradient-text">without</span>
                <span className="absolute -bottom-[3px] left-0 h-[3px] w-full bg-gradient-to-r from-action-primary to-brand-400 rounded-full" />
              </span>{" "}
              the complexity.
            </motion.h1>
            ...
            <motion.p
              variants={fadeUp}
              className="text-body-lg mt-lg text-text-secondary max-w-[480px]"
            >
            ...
            <motion.div
              variants={fadeUp}
              className="mt-xl flex flex-wrap items-center gap-sm"
            >
              <a
                href="#demo"
            ...
            <motion.div variants={fadeUp} className="mt-xl flex items-center gap-lg">
              <div className="flex -space-x-xs">
                {[0,1,2,3].map(i => (
                  <div
                    key={i}
                    className="flex h-[36px] w-[36px] items-center justify-center rounded-full border-2 border-bg-white text-label-sm font-bold text-white shadow-sm"
                    style={{
                      background: [
              ...
              <div>
                <p className="text-body-sm font-semibold text-text-primary">
                  Trusted by 50+ organisations
                </p>
                <div className="flex items-center gap-xs mt-[2px]">
                  {[0,1,2,3,4].map(i => (
                    <svg key={i} width="14" height="14" viewBox="0 0 14 14" fill="#F79009">
                      <path d="M7 1l1.5 3.1 3.5.5-2.5 2.4.6 3.5L7 9.3 3.9 10.5l.6-3.5L2 4.6l3.5-.5L7 1z" />
                    </svg>
                  ))}
                  <span className="text-label-sm text-text-secondary ml-[2px]">4.9/5 rating</span>
                </div>
              </div>
            </motion.div>
          </motion.div>
