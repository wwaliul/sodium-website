          ...
          {useCases.map((useCase, i) => (
            <ScrollReveal key={useCase.title} delay={i + 1}>
              <a
                ...
                className="group flex h-full flex-col rounded-xl border border-border-subtle/50 bg-bg-white p-md shadow-card transition-all duration-300 hover:shadow-elevated hover:-translate-y-[2px]"
              >
                <div className="mb-md flex h-[52px] w-[52px] items-center justify-center rounded-xl bg-brand-100 text-action-primary shadow-sm transition-transform duration-300 group-hover:scale-105">
                  <svg width="24" height="24" viewBox="0 0 24 24">{useCase.icon}</svg>
                </div>
                ...
                <div className="mt-md flex items-center gap-xs text-action-primary text-label-md font-semibold transition-all duration-200 group-hover:gap-sm">
                  Learn more
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="transition-transform duration-200 group-hover:translate-x-[2px]">
